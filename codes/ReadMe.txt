================================================================================
    MICROSOFT 基础类库： PMS 项目概述
===============================================================================

应用程序向导已为您创建了此 PMS 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 PMS 应用程序的每个文件的内容摘要。
...
res\Toolbar.bmp
    ...
    更新 PMS.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

PMSDoc.h、PMSDoc.cpp - 文档
    这些文件包含 CPMSDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 CPMSDoc::Serialize）。
    此文档将具有下列字符串：
        文件扩展名：      pms
        文件类型 ID：        PMS.Document
        主框架标题：  PMS
        文档类型名称：       PMS
        筛选器名称：         PMS Files (*.pms)
        文件的新简称： PMS
        文件类型全称： PMS.Document
PMSView.h、PMSView.cpp - 文档视图
    这些文件包含 CPMSView 类。
    CPMSView 对象用于查看 CPMSDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 PMS.pch 的预编译头文件 (PCH)
